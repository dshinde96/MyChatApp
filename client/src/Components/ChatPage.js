...
const ChatCnt = () => {
    ...
    const uploadfile=async()=>{
        ...
        // formData.append('secretKey',sekretKey);
        ...
        <>
            ...
            <div className="chatCnt">
                <div className="profileCnt">
                    <img src={img_src} style={{ height: "50px", width: "50px", backgroundColor: "white", borderRadius: "100%" }} alt="" />
...
const Chat = () => {
    ...
    return (
        <>
            {curChat ? <ChatCnt /> : <div style={{ width: "68%" }}><img src={Nochat} style={{ height: "100%", width: "100%" }} alt=""/></div>}
        </>
    )
}
